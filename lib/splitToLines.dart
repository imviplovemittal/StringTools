...
class SplitToLinesPage extends StatefulWidget {
  @override
  _SplitToLinesPageState createState() => _SplitToLinesPageState();
}

class _SplitToLinesPageState extends State<SplitToLinesPage> {
  ...
  collateText() {
    ...
    outputTextController.text = inputText.replaceAll(delimiter, "\n");
  }
